...
public class MenuItemsManControllerAbstract extends AbstractCrudController<MenuItemDTO> {

    private final MenuItemsService menuItemsService;

    public MenuItemsManControllerAbstract(MenuItemsService crudService) {
        super(crudService);
