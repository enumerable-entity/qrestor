    ...
    <div class="surface-0 flex justify-content-center">
        <div id="home" class="landing-wrapper overflow-hidden">
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 flex align-items-center justify-content-between relative lg:static mb-3">
                <a class="flex align-items-center" href="#"> <img :src="logoUrl" alt="Qrestor Logo" height="50" class="mr-0 lg:mr-2" /><span class="text-900 font-medium text-2xl line-height-3 mr-8">QRestor</span> </a>
                ...
                <div class="align-items-center surface-0 flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2" style="top: 120px">
                    ...
                    <div class="flex justify-content-between lg:block border-top-1 lg:border-top-none surface-border py-3 lg:py-0 mt-3 lg:mt-0">
                        <Button label="Login" class="p-button-text p-button-rounded border-none font-light line-height-2 text-blue-500" @click="this.$router.push('/auth/login') "></Button>
            ...
            >
                <div class="mx-4 md:mx-8 mt-0 md:mt-4">
                    <h1 class="text-6xl font-bold text-gray-900 line-height-2"><span class="font-light block">QRestor platform</span>menu management solutution</h1>
                    <p class="font-normal text-2xl line-height-3 md:mt-3 text-gray-700">Welcome to our QR Platform, where managing restaurant and catering menus is as easy as scan and serve! Say goodbye to printing costs and hello to seamless digital menus accessible via QR codes. Effortlessly create, customize, and update your menus with just a few clicks, ensuring your customers always have the latest offerings at their fingertips. Join us now and simplify the way you showcase your culinary creations!</p>
